...
var DatepickerViewsDays = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, { children: [(0, import_jsx_runtime21.jsx)("div", { className: theme2.header.base, children: weekDays.map((day, index) => (0, import_jsx_runtime21.jsx)("span", { className: theme2.header.title, children: day }, index)) }), (0, import_jsx_runtime21.jsx)("div", { className: theme2.items.base, children: [...Array(42)].map((_date, index) => {
...
var DatepickerViewsDecades = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime22.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_year, index) => {
...
var DatepickerViewsMonth = ({ theme: customTheme = {} }) => {
  ...
  return (0, import_jsx_runtime25.jsx)("div", { className: theme2.items.base, children: [...Array(12)].map((_month, index) => {
...
var Trigger = ({ refs, children, inline, theme: theme2, disabled, setButtonWidth, getReferenceProps, renderTrigger, ...buttonProps }) => {
  ...
  return inline ? (0, import_jsx_runtime31.jsx)("button", { type: "button", ref: refs.setReference, className: theme2 == null ? void 0 : theme2.inlineWrapper, disabled, ...a11yProps, children }) : (0, import_jsx_runtime31.jsx)(Button, { ...buttonProps, disabled, type: "button", ref: refs.setReference, ...a11yProps, children });
};
...
var DropdownComponent = ({ children, className, dismissOnClick = true, theme: customTheme = {}, renderTrigger, ...props }) => {
  ...
  const handleSelect = (0, import_react20.useCallback)((index) => {
    setSelectedIndex(index);
    setOpen(false);
  }, []);
  const handleTypeaheadMatch = (0, import_react20.useCallback)((index) => {
    if (open) {
...
var ModalHeader = ({ as: Component = "h3", children, className, theme: customTheme = {}, id, ...props }) => {
  const innerHeaderId = (0, import_react23.useId)();
...
// node_modules/flowbite-react/lib/esm/components/Modal/Modal.js
var ModalComponent = (0, import_react25.forwardRef)(({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size = "2xl", theme: customTheme = {}, initialFocus, ...props }, theirRef) => {
  const [headerId, setHeaderId] = (0, import_react25.useState)(void 0);
...
var Radio = (0, import_react29.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
...
var RangeSlider = (0, import_react30.forwardRef)(({ className, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var RatingContext = (0, import_react31.createContext)(void 0);
function useRatingContext() {
  const context = (0, import_react31.useContext)(RatingContext);
  if (!context) {
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime61.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime62.jsx)(RatingContext.Provider, { value: { size }, children: (0, import_jsx_runtime62.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var Select = (0, import_react32.forwardRef)(({ addon, children, className, color = "gray", helperText, icon: Icon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var SidebarContext = (0, import_react33.createContext)(void 0);
function useSidebarContext() {
  const context = (0, import_react33.useContext)(SidebarContext);
  if (!context) {
...
var SidebarItemContext = (0, import_react34.createContext)(void 0);
function useSidebarItemContext() {
  const context = (0, import_react34.useContext)(SidebarItemContext);
  if (!context) {
...
var SidebarCollapse = ({ children, className, icon: Icon, label, chevronIcon: ChevronIcon = HiChevronDown, renderChevronIcon, open = false, theme: customTheme = {}, ...props }) => {
  ...
  const { isCollapsed } = useSidebarContext();
  const [isOpen, setOpen] = (0, import_react35.useState)(open);
  const theme2 = mergeDeep(useTheme().theme.sidebar.collapse, customTheme);
  (0, import_react35.useEffect)(() => setOpen(open), [open]);
...
var SidebarItem = (0, import_react36.forwardRef)(({ active: isActive, as: Component = "a", children, className, icon: Icon, label, labelColor = "info", theme: customTheme = {}, ...props }, ref) => {
  var _a, _b, _c, _d;
...
// node_modules/flowbite-react/lib/esm/components/Tab/Tabs.js
var TabsComponent = (0, import_react38.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  const theme2 = mergeDeep(useTheme().theme.tab, customTheme);
  const id = (0, import_react38.useId)();
  const tabs = (0, import_react38.useMemo)(() => import_react38.Children.map(import_react38.Children.toArray(children), ({ props: props2 }) => props2), [children]);
  const tabRefs = (0, import_react38.useRef)([]);
  const [activeTab, setActiveTab] = (0, import_react38.useState)(Math.max(0, tabs.findIndex((tab) => tab.active)));
  const [focusedTab, setFocusedTab] = (0, import_react38.useState)(-1);
  ...
  return (0, import_jsx_runtime73.jsxs)("div", { className: twMerge(theme2.base, className), children: [(0, import_jsx_runtime73.jsx)("div", { "aria-label": "Tabs", role: "tablist", className: twMerge(theme2.tablist.base, theme2.tablist.styles[style], className), ...props, children: tabs.map((tab, index) => (0, import_jsx_runtime73.jsxs)("button", { type: "button", "aria-controls": `${id}-tabpanel-${index}`, "aria-selected": index === activeTab, className: twMerge(theme2.tablist.tabitem.base, tabItemStyle.base, index === activeTab && tabItemStyle.active.on, index !== activeTab && !tab.disabled && tabItemStyle.active.off), disabled: tab.disabled, id: `${id}-tab-${index}`, onClick: () => handleClick({ target: index }), onKeyDown: (event) => handleKeyboard({ event, target: index }), ref: (element) => tabRefs.current[index] = element, role: "tab", tabIndex: index === focusedTab ? 0 : -1, style: { zIndex: index === focusedTab ? 2 : 1 }, children: [tab.icon && (0, import_jsx_runtime73.jsx)(tab.icon, { className: theme2.tablist.tabitem.icon }), tab.title] }, index)) }), (0, import_jsx_runtime73.jsx)("div", { className: twMerge(theme2.tabitemcontainer.base, tabItemContainerStyle), children: tabs.map((tab, index) => (0, import_jsx_runtime73.jsx)("div", { "aria-labelledby": `${id}-tab-${index}`, className: theme2.tabpanel, hidden: index !== activeTab, id: `${id}-tabpanel-${index}`, role: "tabpanel", tabIndex: 0, children: tab.children }, index)) })] });
});
...
var TableContext = (0, import_react39.createContext)(void 0);
function useTableContext() {
  const context = (0, import_react39.useContext)(TableContext);
  if (!context) {
...
var Textarea = (0, import_react41.forwardRef)(({ className, color = "gray", helperText, shadow, theme: customTheme = {}, ...props }, ref) => {
...
var TimelineContext = (0, import_react42.createContext)(void 0);
function useTimelineContext() {
  const context = (0, import_react42.useContext)(TimelineContext);
  if (!context) {
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  const [isClosed, setIsClosed] = (0, import_react44.useState)(false);
  const [isRemoved, setIsRemoved] = (0, import_react44.useState)(false);
